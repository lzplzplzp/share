...
//	private static final long serialVersionUID = 1L;
	...
	/**未登录*/
	public final static int noLogin = -2;
    ...
    public void jsonOnPage(HttpServletResponse response) {
        ...
        printOnPage(response,JSONObject.toJSONString(result));
    }
    ...
    public JsonResult noLogin(String message){
    	return state(noLogin, message);
    }
